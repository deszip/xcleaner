...
public protocol EnvironmentInteractor {
...
public class Environment: EnvironmentInteractor {
    
    // MARK: - File manager -
    public let fileManager: XCFileManager
    ...
    // MARK: - Arguments -
    public let cli: CommandLine
    public let listOption: MultiStringOption
    public let removeOption: MultiStringOption
    public let timeoutOption: IntOption
    public let appOption: StringOption
    public let helpOption: BoolOption
    public let versionOption: BoolOption
    
    public init(arguments: [String] = Swift.CommandLine.arguments, fileManager: XCFileManager = XCFileManager(fileManager: FileManager.default)) {
    ...
    public func stdout(_ string: String) {
    ...
    public func terminate(success: Bool = true) {
        if success {
            exit(EXIT_SUCCESS)
        }
